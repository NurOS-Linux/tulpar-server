...
public class PackageApiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path == null) {
            // Скачиваем архив пакета
            File packageFile = new File(packageDir, "download/package.apg"); // Пример скачивания архива
            if (!packageFile.exists()) {
                resp.sendRedirect("/errors/404.html?errorCode=Package file not found.");
                return;
            }
